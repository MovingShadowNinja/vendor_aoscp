...
ALARM_PATH := vendor/aoscp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aoscp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aoscp/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/aoscp/prebuilt/common/media/audio/ui
